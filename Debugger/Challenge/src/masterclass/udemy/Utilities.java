...
public class Utilities {
    ...
    //Removes pairs of the same characters that are next to each
    // other, by removing one occurrence of the character.
    //"ABBCDEEF" -> "ABCDEF"
    //"ABCBDEEF" -> "ABCBDEF"(the two B's are not next to each other )
    ...
    // Performs a conversion based on some internal rule.
